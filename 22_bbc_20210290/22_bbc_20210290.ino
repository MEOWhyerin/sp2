...
#define _DUTY_MAX 2399 // 2000
#define _DUTY_NEU 1310 // 1500
#define _DUTY_MIN 553 // 1000

#define _SERVO_ANGLE_DIFF  90
#define _SERVO_SPEED       1000  // servo speed

#define _BANGBANG_RANGE    270  // duty up and down for bangbang control
...
float volt_to_distance(int x)
{
  ...
  return 256 + 2.62 * x + -0.0208 * x*x + 4.48E-05*x*x*x + -3.09E-08*x*x*x*x;
}
